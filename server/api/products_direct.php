<?php
/**
 * Direct Products API Endpoint
 * 
 * This file serves as a direct API endpoint for product-related operations,
 * placed in the server/api directory for direct access through the router.
 */
...
try {
    ...
    if ($stmt) {
        ...
        // Return error response for failed statement preparation
