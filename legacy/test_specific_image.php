...
// Specific test image path for product 22789
$testImagePath = "Tea Catalogue/22789/22789.jpg";

echo "<h1>Specific Image Test</h1>";
echo "<p>Testing specific image path: {$testImagePath}</p>";
...
// Display direct image link
echo "<p>Direct image URL: <a href='/giggles-tea/image?path=Tea%20Catalogue/22789/22789.jpg' target='_blank'>/giggles-tea/image?path=Tea%20Catalogue/22789/22789.jpg</a></p>";

// Display the image if it exists
if (file_exists($fullPath)) {
    echo "<h2>Image Preview:</h2>";
    echo "<img src='/giggles-tea/image?path=Tea%20Catalogue/22789/22789.jpg' alt='Test Image' style='max-width: 300px;'>";
} else {
